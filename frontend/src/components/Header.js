...
import {Typography,Box,Button,Tabs} from '@mui/material';
...
const Header = () => {
    ...
    return (
        <AppBar 
            ...
            sx={{
                background:
                    "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,24,121,1) 35%, rgba(0,212,255,1) 100%)"
            }}
        >
            <Toolbar>
                <Typography className={classes.font} variant="h4">Travel Log App</Typography>
