import {
    ...
    CardContent,
    CardHeader,
    CardMedia,IconButton,Typography,Box
    } from '@mui/material';
...
const Blog = ({location,description,imageURL,userName ,cost,places_to_visit, isUser,id }) => {
    ...
    <div>
        ...
        sx={{
            ...
            mt:2 ,
            padding:2 ,
            boxShadow:"5px 5px 10pc #ccc", ":hover:":{
        ...
        {isUser && (
            ...
            <Typography className={classes.font} variant="body2" color="text.secondary">
                <b>{userName}</b> {":"} {description} {cost} {places_to_visit}
            </Typography>
            </CardContent>
